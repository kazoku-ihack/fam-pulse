            ...
            properties: {
              ...
              attester: {
                ...
                properties: {
                  ...
                  signer: { type: 'string', description: 'must equal ATTESTER_ADDRESS (or REGISTERED_SIGNER as a fallback) — checked directly against this field, not via ECDSA recovery from payload_hash/signature' },
                  signature: { type: 'string', description: 'stored as-is and echoed back as `attesterSig`, not independently re-verified' },
        ...
        responses: {
          201: jsonResponse('Attestation verified and persisted', {
            ...
            properties: {
              ...
              attester: { type: 'string', description: 'echoes attester.signer verbatim (already checked against ATTESTER_ADDRESS/REGISTERED_SIGNER above)' },
          ...
          422: errRes('CONTRACT_ADDRESS_MISMATCH / CHAIN_ID_MISMATCH / ATTESTER_ADDRESS_MISMATCH'),
